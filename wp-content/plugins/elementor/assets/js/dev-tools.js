...
var Module = exports["default"] = /*#__PURE__*/function () {
  ...
  return (0, _createClass2.default)(Module, [{
    ...
    value: function consoleWarn() {
      var _console;
      var style = "font-size: 12px; background-image: url(\"".concat(elementorDevToolsConfig.urls.assets, "images/logo-icon.webp\"); background-repeat: no-repeat; background-size: contain;");
